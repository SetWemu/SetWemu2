...
// SetWemu Brand Colors - Final Design System
...
export const COLORS = {
  ...
  // STATUS COLORS
  success: '#4CC1D4',        // Using teal for success (fits your palette)
  error: '#FF6B6B',          // Red for errors (need this for warnings)
  warning: '#FFB84D',        // Orange for warnings (need this)
  info: '#ADF3FF',           // Using primary blue for info
