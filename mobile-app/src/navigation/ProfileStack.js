...
const ProfileScreen = ({ navigation }) => (
  <ScrollView style={styles.container}>
    ...
    <View style={styles.section}>
      ...
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('MyTickets')}>
        <Text style={styles.btnText}>🎟️  My Tickets</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Favorites')}>
        <Text style={styles.btnText}>❤️  Favorites</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Reviews')}>
    ...
    <View style={styles.section}>
      ...
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Following')}>
        <Text style={styles.btnText}>👥  Following</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Followers')}>
        <Text style={styles.btnText}>👥  Followers</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('ChatList')}>
        <Text style={styles.btnText}>💬  Messages</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Notifications')}>
    ...
    {/* Test */}
    <View style={styles.section}>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.getParent().navigate('Test')}>
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: '#1e293b', padding: 16, borderRadius: 12, marginBottom: 10, borderWidth: 1, borderColor: '#334155' },
