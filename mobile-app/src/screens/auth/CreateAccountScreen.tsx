      ...
      >
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
          ...
          <View style={s.header}>
            ...
            <Text style={s.subtitle}>Join SetWemu and discover amazing events</Text>
          </View>
          ...
          <View style={s.toggleContainer}>
            <TouchableOpacity 
              style={[s.toggleBtn, accountType === 'personal' && s.toggleBtnActive]}
            ...
            <TouchableOpacity 
              style={[s.toggleBtn, accountType === 'business' && s.toggleBtnActive]}
              onPress={() => setAccountType('business')}
            >
              <Text style={[s.toggleText, accountType === 'business' && s.toggleTextActive]}>
                Business
              </Text>
            </TouchableOpacity>
          </View>
...
const s = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: '900', color: C.text.primary, marginBottom: 8, letterSpacing: -0.5 },
  subtitle: { fontSize: 14, color: C.text.secondary },
  
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.bg.card, borderRadius: 12, paddingHorizontal: 16, height: 54, marginBottom: 14, borderWidth: 1, borderColor: C.border.light, gap: 12 },
  input: { flex: 1, color: C.text.primary, fontSize: 15, fontWeight: '600' },
  
  label: { fontSize: 13, fontWeight: '700', color: C.text.secondary, marginBottom: 10, marginTop: 10, textTransform: 'uppercase', letterSpacing: 0.8 },
  toggleContainer: { flexDirection: 'row', backgroundColor: C.bg.card, borderRadius: 12, padding: 4, marginBottom: 20, gap: 4 },
  ...
  checkbox: { width: 22, height: 22, borderRadius: 6, borderWidth: 2, borderColor: C.border.light, alignItems: 'center', justifyContent: 'center' },
  ...
  signupBtn: { backgroundColor: C.blue.light, borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginBottom: 20 },
