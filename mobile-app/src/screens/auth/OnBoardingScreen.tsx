...
const slides = [
  {
    ...
    desc: 'Discover the best tech, music, and art events happening in Sri Lanka.',
    icon: 'map-outline',
  },
  {
    id: 2,
    title: 'Connect with People',
    desc: 'See who is attending and expand your professional network.',
    icon: 'people-outline',
  },
  {
    id: 3,
    title: 'Book Your Tickets',
    desc: 'Secure your spot instantly with our seamless booking system.',
