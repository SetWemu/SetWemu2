...
const FollowersListScreen = () => {
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TouchableOpacity style={[styles.button, item.isFollowing && styles.followingButton]}>
        <Text style={[styles.buttonText, item.isFollowing && styles.followingButtonText]}>
...
const styles = StyleSheet.create({
  ...
  followingButtonText: { color: "#1DA1F2" },
});