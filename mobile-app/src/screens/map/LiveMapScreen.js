...
const CATEGORIES = ['Music', 'Art', 'Food', 'Tech', 'Business', 'Wellness'];
          ...
          {CATEGORIES.map(cat => (
            ...
            >
              <Text
                style={[
                  styles.filterText,
                  selectedCategories.includes(cat) && styles.filterTextActive,
                ]}
              >
                {cat}
              </Text>
        ...
        {selectedEvent && (
          <View style={styles.eventCard}>
            ...
            <View style={styles.cardRow}>
              <Image
                source={{
                  uri: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3',
                }}
...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: COLORS.text.primary, marginLeft: 10 },
  ...
  filterChipActive: {
    ...
    backgroundColor: 'rgba(76, 193, 212, 0.15)',
  },
  ...
  activeBubble: { backgroundColor: COLORS.blue.brand },
  ...
  eventTitle: { color: COLORS.text.primary, fontSize: 17, fontWeight: '800' },
  priceTag: { color: COLORS.blue.brand, fontSize: 20, fontWeight: '900' },
  primaryButton: {
  ...
  primaryButtonText: { color: COLORS.text.inverse, fontWeight: '900' },
